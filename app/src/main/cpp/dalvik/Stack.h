...
extern dvmHandleStackOverflow_func dvmHandleStackOverflowhook;

typedef int (*dvmLineNumFromPC_func)(const Method* method, u4 relPc);
extern dvmLineNumFromPC_func dvmLineNumFromPChook;

typedef int (*dvmCleanupStackOverflow_func)(Thread* self, const Object* exception);
 extern dvmCleanupStackOverflow_func dvmCleanupStackOverflowhook;
